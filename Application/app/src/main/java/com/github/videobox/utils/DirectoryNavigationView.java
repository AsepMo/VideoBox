...
public class DirectoryNavigationView {
    ...
    public void setDirectoryButtons(String path) {
        ...
        t0.setLayoutParams(new LinearLayout.LayoutParams(WRAP_CONTENT, MATCH_PARENT, Gravity.CENTER_VERTICAL));
        t0.setText("/");
        t0.setTextSize(text_size);
        t0.setTextColor(mActivity.getResources().getColor(R.color.activity_text_color));        
        t0.setTag(dir);
        ...
        for (int i = 1; i < parts.length; i++) {
            ...
            LinearLayout divider = (LinearLayout) mActivity.getLayoutInflater().inflate(R.layout.item_navigation_divider, null);
            fv1.addView(divider);
            ...
            t2.setTextColor(mActivity.getResources().getColor(R.color.activity_text_color));
            t2.setTag(dir);
            ...
            t2.setOnLongClickListener(new View.OnLongClickListener() {
                public boolean onLongClick(View view) {
                    String dir1 = (String) view.getTag();
                    FileTools.savetoClipBoard(mActivity, dir1);
                    return true;
                }
            });
            ...
            scrolltext.postDelayed(new Runnable() {
                @Override
                public void run() {
                    HorizontalScrollView hv = (HorizontalScrollView) mActivity.findViewById(R.id.scroll_text);
