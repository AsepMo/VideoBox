package com.github.videobox.graphics.gles;
...
public class SphericalSceneRenderer {
    ...
    public SphericalSceneRenderer(Context context) {
        shaderProgram = new ShaderProgram(FileTools.readRawTextFile(context, R.raw.video_vertex_shader), FileTools.readRawTextFile(context, R.raw.video_fragment_shader));
