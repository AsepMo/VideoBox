...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        indicatorLayoutManager = new LinearLayoutManager(context, orientation, false);
    ...
    private OnBannerLoadMore onBannerLoadMore;
    public void setOnBannerLoadMore(OnBannerLoadMore onBannerLoadMore)
    {
        this.onBannerLoadMore = onBannerLoadMore;
    }
    
    public interface OnBannerLoadMore
    {
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mRecyclerView.setOnScrollListener(new EndlessRecyclerOnScrollListner(indicatorLayoutManager) {
                @Override
                public void onLoadMore(int current_page) {
                    Log.i(TAG, "onLoadMore: " + current_page);
                    if(onBannerLoadMore ==null)
                    {
                        onBannerLoadMore.onLoadMore(current_page);
                    }
                }
            });
        hasInit = true;
